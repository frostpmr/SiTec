jQuery(document).ready(function($) {
    ...
    $('.input-colorpicker').ColorPicker({
        ...
        onChange: function(hsb, hex, rgb, el) {
            ...
            el.value = new_color;
            if (elName == 'sticky_menu_bg_color') {
                skins_data[$default_skin][elName] = rgb_color(rgb, '0.9');
                skins_data[$default_skin][elName + '_ie'] = rgb_color(rgb);
            }
            else if (elName == 'footer_heading_border_color') {
                skins_data[$default_skin][elName] = rgb_color(rgb, '0.6');
                skins_data[$default_skin][elName + '_ie'] = rgb_color(rgb);
            }
            else {
